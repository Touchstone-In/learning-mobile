...
val TsinOnPrimary = Color(0xFFFFFFFF)
val TsinPrimaryContainer = Color(0xFFD6E3FF)
val TsinOnPrimaryContainer = Color(0xFF001B3E)

// Secondary (muted blue-grey, Google Console style)
val TsinSecondary = Color(0xFF565F71)
val TsinOnSecondary = Color(0xFFFFFFFF)
val TsinSecondaryContainer = Color(0xFFDAE2F9)
val TsinOnSecondaryContainer = Color(0xFF131C2B)

// Tertiary (accent for highlights)
val TsinTertiary = Color(0xFF1A73E8) // Google Blue for interactive
val TsinOnTertiary = Color(0xFFFFFFFF)
val TsinTertiaryContainer = Color(0xFFD3E3FD)
val TsinOnTertiaryContainer = Color(0xFF062E6F)

// Error
val TsinError = Color(0xFFD93025)
val TsinOnError = Color(0xFFFFFFFF)
